...
export const projectsData = [
  ...
  {
    id: 2,
    name: "EduNest ( EDUCATION WEBSITE )",
    ...
    date: "2025-06-30",
    demoLink: "https://edu-nest-frontend.vercel.app",
  },
  {
    id: 3,
...
export const BtnList = [
  ...
  // { label: "Contact", link: "/contact", icon: "contact", newTab: false },
   { label: "", link: "/about", icon: "about", newTab: false },
  { label: "", link: "/projects", icon: "projects", newTab: false },
  { label: "", link: "/contact", icon: "contact", newTab: false },
  // {
  //   label: "Github",
