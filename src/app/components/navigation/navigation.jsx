  ...
  return (
    <NavContainer>
      <HeroContent>
        ...
        <Brand>Rubaiya Khan Jerin</Brand>

        <Divider />

        <RoleText>
          I build scalable <span>Full-Stack Web Applications</span> with clean
          architecture and create smooth, interactive UI experiences.
        </RoleText>
        ...
        <StatusIndicator>Available for work</StatusIndicator>
...
//   padding: 36px; /* Increased internal padding */
//   border-radius: 18px;
...
//     width: calc(100% - 32px);
//     max-width: 420px;
//     padding: 28px 24px; /* Added more padding for mobile view as well */
//     border-radius: 16px;
//   }
// `;
...
//       box-shadow: 0 6px 18px rgba(181, 255, 59, 0.25);
//     }
//   }
...
//       box-shadow: 0 6px 18px rgba(181, 255, 59, 0.2);
//     }
//   }
// `;
